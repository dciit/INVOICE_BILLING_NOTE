...
export default function InvoiceConfirm() {
    ...
    const onSearch = () => {
        ...
        service.PostInvoiceRequert({ venderCode: auth.username }).then((res) => {
                try {
    ...
    return (
        <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ maxHeight: 500, overflowY: 'auto' }} className="customTable">
                <Table
                    columns={columns}
            ...
            {
                dataView.length > 0 && (
                    <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 20, marginLeft: 50, marginRight: 50 }}>
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <Checkbox checked={checkAllCorrect} onChange={e => setCheckAllCorrect(e.target.checked)}>
                                ข้าพเจ้าได้ตรวจสอบรายการทั้งหมดแล้วมีความถูกต้องครบถ้วน
                            </Checkbox>

                            <Checkbox checked={checkSomeIncorrect} onChange={e => setCheckSomeIncorrect(e.target.checked)}>
                                ข้าพเจ้าได้ตรวจสอบรายการทั้งหมดแล้วมีบางรายการไม่ถูกต้อง
                            </Checkbox>
                        </div>
